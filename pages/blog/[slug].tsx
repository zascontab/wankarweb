...
export default function BlogPost({ post, categories }: any) {
                            ...
                            <div className="single-post">
                                <div className="single-post-meta">
                                    ...
                                    <ul className="single-post-meta-info">
                                        ...
                                        {post.tags.map((tag: { slug: Key | null | undefined; name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; }) => (
                                            <li key={tag.slug}>
...
export async function getStaticPaths() {
    ...
    if (butterToken) {
        try {
            ...
            return {
                paths: posts.map((post: { slug: any; }) => `/blog/${post.slug}`),
                fallback: true
            };
        } catch (e) {
